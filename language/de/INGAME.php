...
$LNG['cff_mission_own_20']      = 'Eine deiner %s vom %s %s %s erreicht die Koordinaten %s für eine Quest';
$LNG['cff_mission_own_1']       = 'Eine deiner %s kehrt vom %s %s %s zurück zum %s %s %s. Mission: %s';
$LNG['cff_mission_quest_back_20']      = 'Eine deiner %s kehrt von einer Quest zurück zum %s %s %s.';
