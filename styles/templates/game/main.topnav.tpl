<div class="container-fluid">
    <div class="row resourcen_container text-center">
            ...
            <div class="col-lg-2 col-sm-2">
                {if $shortlyNumber}
                    {if !isset($resourceData.current)}
                        ...
                        {if $resourceID != 911}
                            <span class="res_item {$resClass}" data-max="{$resourceData.max}"
                                  title="{$resourceData.production|number_format:0:",":"."} pro Stunde"> / {shortly_number($resourceData.max)}</span>
                        {else} {*energy*}
                    ...
                    {else}
                        <img src="{$dpath}images/{$resourceData.name}.png" alt="{$resourceData.name}"
                             title="{$resourceData.name}">
                        <span class="res_item {$resClass}" data-max="{$resourceData.max}"
                              data-current="{$resourceData.current}"
                              data-production="{$resourceData.production}"
                              title="{$resourceData.production|number_format:0:",":"."} pro Stunde">
