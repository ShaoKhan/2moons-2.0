...
<table style="width:100%;" id="resulttable">
	...
	<tr>
		...
		<td><a href="#" onclick="return Dialog.PM({$searchRow.userid});" title="{$LNG.sh_write_message}"><i class="far fa-envelope" title="{$LNG.sh_write_message}" style="font-size: 15px;"></i></a>&nbsp;<a href="#" onclick="return Dialog.Buddy({$searchRow.userid});" title="{$LNG.sh_buddy_request}"><i class="far fa-handshake" style="font-size: 15px;"></i></a></td>
